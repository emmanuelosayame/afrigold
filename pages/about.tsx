    ...
    <div className=''>
      ...
      <div className='md:h-screen relative bg-black '>
        <div className='text-white flex justify-end items-center max-w-screen-xl mx-auto h-full'>
          <div className='w-[500px] xl:w-[600px] flex flex-col gap-5 items-end py-20 px-10 md:p-10 md:mr-10 xl:mr-0'>
            <h4 className='text-[35px] font-bold'>ARE YOU HUNGRY?</h4>
            <h5 className='xl:text-[32px] text-[26px] text-end'>
      ...
      <section className='max-w-screen-lg mx-auto p-5 space-y-5'>
        ...
        <p className='text-lg'>
          ...
          services, A platform that connects the businesses directly to their
          end users with the aim of creating accessibility, convenience and ease
          within the hospitality industry. We aim to be the best digital menu
          for restaurants across Africa and globally with soft food and
          logistics activities across other sectors.{' '}
        </p>
        ...
        <div className='flex flex-col md:flex-row py-10'>
          ...
          <div className='w-full md:w-1/3 text-lg flex flex-col justify-center gap-10'>
            <p>
              Our mission: We aim at establishing perfect peer to peer platforms
              of food purchase, excellent digital menu for restaurants and food
              lovers and peer to peer logistics services.
            </p>
            <p>
              Our vision: Is to be the leading provider of food and logistics
              impacting growth in the hospitality industry through the use of
              enhanced technology.
            </p>
          </div>
        </div>
